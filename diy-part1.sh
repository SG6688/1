...
#git clone https://github.com/leshanydy2022/luci-theme-bootstrap-mod package/luci-theme-bootstrap-mod
# git clone https://github.com/DevOpenWRT-Router/luci-theme-lafite-port package/luci-theme-lafite-port
